...
exports.favoritesController = {
    ...
    save: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const favorite = yield favoriteService_1.favoriteService.create(userId, Number(productId));
    ...
    delete: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            yield favoriteService_1.favoriteService.delete(userId, Number(productId));
