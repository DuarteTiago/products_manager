...
export const locale: Locale = {
  ...
  translations: {
    ...
    labels: {
      ...
      products: "Produtos",
      productImage: "URL imgens do produto",
      favorites: "Favoritos",
    ...
    properties: {
      ...
      role: "Perfil",
      name: "Produto",
      ownerName: "Proprietário do produto",
      description: "Descrição",
      productPrice: "Preço",
      productImage: "URL imgens do produto",
      productCode: "Código do produto",
      productId: "produto",
      uploadImage: "Imagem do produto",
    ...
    messages: {
      ...
      thereWereValidationErrors:
        "Existem erros de validação - código do produto já existente",
      forbiddenError:
      ...
      loginWelcome: "Área administrativa de produtos G&M. Bom trabalho!",
